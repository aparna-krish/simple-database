...
public class HeapPage implements Page {
    ...
    */
    ...
    public void deleteTuple(Tuple t) throws DbException {
        ...
        if (rid == null) {
            throw new DbException("Tuple's record id is invalid");
        }
    ...
    public void insertTuple(Tuple t) throws DbException {
        ...
        // Find the first empty slot and insert the tuple
        ...
        throw new DbException("Couldn't add tuple to page");
    ...
    private void markSlotUsed(int i, boolean value) {
        ...
        if (value) {
            // Set the bit to mark the slot as used
            header[slot] |= (1 << bit);
        } else {
            // Clear the bit to mark the slot as unused
            header[slot] &= ~(1 << bit);
        }
    }
    ...
    public Iterator<Tuple> iterator() {
        ...
        for (int i = 0; i < tuples.length; i++) {
            if (isSlotUsed(i)) {
                iterable.add(tuples[i]);
            }
        }
        return new HeapPageIterator<Tuple>(iterable);
    }
    ...
    public class HeapPageIterator<Tuple> implements Iterator<Tuple>{
        ...
        @Override
        public void remove() {
            throw new UnsupportedOperationException("Could not remove tuples");
        }
    }
